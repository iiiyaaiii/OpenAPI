...
Resource          ${CURDIR}../../../../Resource/WeLoveShopping/init.robot
...
*** Test Cases ***
TC_MC_12733
    [Documentation]    Resize product image for use in levelC search
...
TC_MC_12734
    [Documentation]    Resize product image for use in levelD
...
TC_MC_12735
    [Documentation]    Resize product image for use in levelD zoom mode
...
TC_MC_12736
    [Documentation]    Resize product image for use in StoreFront
...
TC_MC_12737
    [Documentation]    Resize product image for use in levelC search mobile
    [Tags]    Regression    High    Resize-Web    SmokeTest
...
TC_MC_12738
    [Documentation]    Resize product image for use in levelD mobile
    [Tags]    Regression    High    Resize-Web
