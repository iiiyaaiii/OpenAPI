...
TC_Join_Campaign
    ...
    Execute Javascript    $('#date_join_campaign').val('01/01/2016 00:00 - 31/12/2017 23:59');
    Execute Javascript    $('#date_show_campaign').val('01/01/2016 00:00 - 31/12/2017 23:59');
    ...
    WMS Select Product to Campaign    join    ${campaign_id}    L90100*
    WMS Select Product to Campaign    join    ${campaign_id}    ${robot_store1_join_camapign}    9
    WMS Select Product to Campaign    join    ${campaign_id}    ${robot_store2_join_camapign}    9
...
TC_NonJoin_Campaign
    ...
    WMS Select Product to Campaign    non-join    ${campaign_id}    ${robot_store1_none_join_camapign}    9
    WMS Select Product to Campaign    non-join    ${campaign_id}    ${robot_store2_none_join_camapign}    9
...
TC_PromotionItem_FixPrice
    ...
    WMS Select Product to Campaign    promotion    ${campaign_id}    ${robot_store1_promotion_item_price}    9
    WMS Select Product to Campaign    promotion    ${campaign_id}    ${robot_store2_promotion_item_price}    9
...
TC_PromotionItem_DiscountPercent
    ...
    WMS Select Product to Campaign    promotion    ${campaign_id}    ${robot_store1_promotion_item_percent}    9
    WMS Select Product to Campaign    promotion    ${campaign_id}    ${robot_store2_promotion_item_percent}    9
...
TC_PromotionCart_PriceDiscountPrice
    ...
    WMS Select Product to Campaign    promotion    ${campaign_id}    ${robot_store2_promotion_cart_price_by_price}    9
...
TC_PromotionCart_PriceDiscountPercent
    ...
    WMS Select Product to Campaign    promotion    ${campaign_id}    ${robot_store2_promotion_cart_percent_by_price}    9
...
TC_PromotionCart_QtyDiscountPrice
    ...
    WMS Select Product to Campaign    promotion    ${campaign_id}    ${robot_store2_promotion_cart_price_by_qty}    9
...
TC_PromotionCart_QtyDiscountPercent
    ...
    WMS Select Product to Campaign    promotion    ${campaign_id}    ${robot_store2_promotion_cart_percent_by_qty}    9
...
TC_PromotionItem_FixPriceEdit
    ...
    WMS Select Product to Campaign    promotion    ${campaign_id}    ${robot_store1_test_promotion_item2}
    WMS Select Product to Campaign    promotion    ${campaign_id}    ${robot_store2_test_promotion_item2}
...
TC_PromotionCart_PriceDiscountPriceEdit
    ...
    WMS Select Product to Campaign    promotion    ${campaign_id}    ${robot_store1_test_promotion_cart1}
    WMS Select Product to Campaign    promotion    ${campaign_id}    ${robot_store2_test_promotion_cart1}
...
TC_PromotionCustomPrice
    ...
    WMS Select Product to Campaign    promotion_type3    ${campaign_id}    ${robot_store1_custom_price}    9    199
    WMS Select Product to Campaign    promotion_type3    ${campaign_id}    ${robot_store2_custom_price}    9    399
...
TC_PromotionCustomPrice_Edit
    ...
    WMS Select Product to Campaign    promotion_type3    ${campaign_id}    ${robot_store1_promotion_custom_test1}    0    199
    WMS Select Product to Campaign    promotion_type3    ${campaign_id}    ${robot_store2_promotion_custom_test1}    0    199
...
TC_Join_Campaign_FeeZero
    ...
    Click Element    //button[contains(text(),'+ สินค้าราคาเดียว และ แบบช่วงราคา')]
    Sleep    1s
    Execute Javascript    $('#campaign_name_th').val('[QA-Automation] Join Campaign Fee Zero');
    Execute Javascript    $("input[id='campaign_fee_2']").click()
    Execute Javascript    $("input[id='price_fee']").val('0');
    Choose File    id=file_banner    ${CURDIR}/Images/join_banner.jpg
    Choose File    id=file_topbanner    ${CURDIR}/Images/join_top_banner.jpg
    Choose File    id=file_bannermobile    ${CURDIR}/Images/join_banner.jpg
    Execute Javascript    $("input[name='discount_type']")[1].click()
    ...
    Execute Javascript    $('#date_show_campaign').val('01/01/2016 00:00 - 31/12/2020 23:59');
    Select Frame    id=description_th_ifr
    Input Text    //body[@id='tinymce']    Join Campaign Fee Zero create by robot script !!
    Unselect Frame
    Execute Javascript    $("input[name='product_limit']")[1].click()
    Execute Javascript    $("input[id='product_limit_input']").val('5');
    Sleep    0.5s
    Input Text    //input[@id='min_quantity']    1
    Execute Javascript    $("input[name='order_product']")[1].click()
    Input Text    //input[@id='slug_th']    qa-robot-join
    ...
    ${campaign_id}=    Execute Javascript    return $('.table > tbody > tr')[0].id
    ${campaign_id}=    Remove String    ${campaign_id}    row-
    Write Variable to File    join_campaign_Fee_Zero_limit    ${campaign_id}